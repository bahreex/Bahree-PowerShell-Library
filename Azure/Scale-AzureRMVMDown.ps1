...
.DESCRIPTION
    ...
    and within this repository as a CSV file named "Azure-VM-Sizes-29122017.csv". You need to be already logged into 
...
.Parameter SizeStep
    Scalar value between -8 to -1. This has a default value of -1, which will resize the VM to Immediately before size 

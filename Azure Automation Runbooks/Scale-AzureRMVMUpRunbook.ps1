...
.DESCRIPTION
    ...
    at the last size of the VM family, you will not be able to scale up the VM any further as cross-family Scaling-Up is not allowed by Microsoft Azure. Since Microsoft does 
...
function ResizeVM ($rgName, $vmName, $newVMSize) {
    ...
    Write-Output "The Scaling-Up Job for # $vmName is $Job!"
}
